    ...
    t.fn.mDatatable = function(e) {
        if (0 !== t(this).length) {
            ...
            var n = {
                ...
                init: function(e) {
                    var o = !1;
                    return null === e.data.source && (n.extractTable(),
                    o = !0),
                    n.setupBaseDOM.call(),
                    n.setupDOM(a.table),
                    n.spinnerCallback(!0),
                    ...
                    "remote" !== e.data.type && "local" !== e.data.type || ((!1 === e.data.saveState || !1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage) && n.stateRemove(n.stateId),
                    "local" === e.data.type && "object" == typeof e.data.source && (a.dataSet = a.originalDataSet = n.dataMapCallback(e.data.source)),
                    n.dataRender()),
                    o || (n.setHeadTitle(),
                    n.getOption("layout.footer") && n.setHeadTitle(a.tableFoot)),
                    void 0 !== e.layout.header && !1 === e.layout.header && t(a.table).find("thead").remove(),
                    void 0 !== e.layout.footer && !1 === e.layout.footer && t(a.table).find("tfoot").remove(),
                    null !== e.data.type && "local" !== e.data.type || (n.setupCellField.call(),
                    ...
                    var n = []
                      , o = t(a).find("tr:first-child th").get().map(function(a, o) {
                        ...
                        for (var r in e.columns)
                            e.columns[r].field === i && (l = t.extend(!0, {}, e.columns[r], l));
                        return n.push(l),
                        i
                    });
                    e.columns = n;
                ...
                layoutUpdate: function() {
                    ...
                    n.columnHide.call(),
                    n.resetScroll(),
                    n.isInit || (t(a).trigger("m-datatable--on-init", {
                                        ...
                                        if (t(o).find(".m-datatable__lock").length > 0)
                                            ...
                                            t(o).find(".m-datatable__row").each(function() {
                                                ...
                                                t(this).find(".m-datatable__cell").each(function() {
                                                    ...
                                                    void 0 !== o ? (void 0 === o.left && !0 !== o || t(this).appendTo(e),
                                                    void 0 !== o.right && t(this).appendTo(n)) : t(this).appendTo(a)
                                                }),
                                                t(this).remove()
                                            }),
                                            e.lockEnabled.left.length > 0 && (t(a.wrap).addClass("m-datatable--lock"),
                                            t(i).appendTo(o)),
                                            (e.lockEnabled.left.length > 0 || e.lockEnabled.right.length > 0) && t(l).appendTo(o),
                                            e.lockEnabled.right.length > 0 && (t(a.wrap).addClass("m-datatable--lock"),
                                            t(r).appendTo(o))
                                        } else
                ...
                lockEnabledColumns: function() {
                    ...
                    return t.each(n, function(t, e) {
                        void 0 !== e.locked && (void 0 !== e.locked.left && mUtil.getBreakpoint(e.locked.left) <= a && o.left.push(e.locked.left),
                        void 0 !== e.locked.right && mUtil.getBreakpoint(e.locked.right) <= a && o.right.push(e.locked.right))
                    }),
                    o
                },
                afterRender: function(e, o) {
                    o.table == t(a.wrap).attr("id") && t(a).ready(function() {
                        ...
                        t(a.table).find(".m-datatable__row").css("height", ""))),
                        t(a.tableBody).find(".m-datatable__row").removeClass("m-datatable__row--even"),
                        t(a.wrap).hasClass("m-datatable--subtable") ? t(a.tableBody).find(".m-datatable__row:not(.m-datatable__row-detail):even").addClass("m-datatable__row--even") : t(a.tableBody).find(".m-datatable__row:nth-child(even)").addClass("m-datatable__row--even"),
                        n.isLocked() && n.redraw(),
                ...
                adjustLockContainer: function() {
                    ...
                    return t(a.table).find(".m-datatable__lock--scroll").css("width", l),
                    l
                },
                dragResize: function() {
                ...
                setupBaseDOM: function() {
                    ...
                    "TABLE" === t(a).prop("tagName") ? (a.table = t(a).removeClass("m-datatable").addClass("m-datatable__table"),
                    0 === t(a.table).parents(".m-datatable").length && (a.table.wrap(t("<div/>").addClass("m-datatable").addClass("m-datatable--" + e.layout.theme)),
                    a.wrap = t(a.table).parent())) : (a.wrap = t(a).addClass("m-datatable").addClass("m-datatable--" + e.layout.theme),
                    a.table = t("<table/>").addClass("m-datatable__table").appendTo(a)),
                    void 0 !== e.layout.class && t(a.wrap).addClass(e.layout.class),
                    t(a.table).removeClass("m-datatable--destroyed").css("display", "block"),
                    void 0 === t(a).attr("id") && (n.setOption("data.saveState", !1),
                    t(a.table).attr("id", mUtil.getUniqueID("m-datatable--"))),
                    n.getOption("layout.minHeight") && t(a.table).css("min-height", n.getOption("layout.minHeight")),
                    n.getOption("layout.height") && t(a.table).css("max-height", n.getOption("layout.height")),
                    null === e.data.type && t(a.table).css("width", "").css("display", ""),
                    a.tableHead = t(a.table).find("thead"),
                    0 === t(a.tableHead).length && (a.tableHead = t("<thead/>").prependTo(a.table)),
                    a.tableBody = t(a.table).find("tbody"),
                    0 === t(a.tableBody).length && (a.tableBody = t("<tbody/>").appendTo(a.table)),
                    void 0 !== e.layout.footer && e.layout.footer && (a.tableFoot = t(a.table).find("tfoot"),
                    0 === t(a.tableFoot).length && (a.tableFoot = t("<tfoot/>").appendTo(a.table)))
                },
                ...
                setupTemplateCell: function(o) {
                    ...
                    t(o).find(".m-datatable__row").each(function(e, o) {
                        ...
                        void 0 === l && (l = {},
                        t(o).find(".m-datatable__cell").each(function(e, a) {
                        ...
                        t(o).find(".m-datatable__cell").each(function(o, r) {
                            ...
                            if (void 0 !== s && void 0 !== s.template) {
                                ...
                                "function" == typeof s.template && (d = s.template(l, e, a));
                    ...
                    0 !== a.dataSet.length) {
                            ...
                            t(a).find(".m-datatable__cell").each(function(e, a) {
                                ...
                                if (void 0 !== i) {
                                    ...
                                    if (void 0 !== i.selector && !1 !== i.selector) {
                                        if (t(a).find('.m-checkbox [type="checkbox"]').length > 0)
                                            return;
                                    ...
                                    if (void 0 !== i.subtable && i.subtable) {
                                        if (t(a).find(".m-datatable__toggle-subtable").length > 0)
                                            return;
                        ...
                        var i = function(e) {
                            ...
                            if (void 0 !== a && void 0 !== a.selector && !1 !== a.selector) {
                                ...
                                void 0 !== a.selector.class && t(l).addClass(a.selector.class),
                                t(i).children().html(l)
                            }
                        };
                        e.layout.header && i(t(a.tableHead).find(".m-datatable__row").first()),
                        e.layout.footer && i(t(a.tableFoot).find(".m-datatable__row").first())
                    }
                },
                adjustCellsWidth: function() {
                    ...
                    if (o > 0) {
                        ...
                        t(a.table).find(".m-datatable__row").find(".m-datatable__cell:visible").each(function(e, a) {
                            var n = i
                              , o = t(a).data("width");
                            void 0 !== o && (n = o),
                            t(a).children().css("width", parseInt(n))
                        })
                    }
                    return a
                },
                    ...
                    var o = {
                        ...
                        init: function() {
                            ...
                            if (e.layout.scroll) {
                                ...
                                t(l).find(".m-datatable__row").length > 0 && t(l).length > 0 ? (o.scrollHead = t(a.tableHead).find("> .m-datatable__lock--scroll > .m-datatable__row"),
                                o.scrollFoot = t(a.tableFoot).find("> .m-datatable__lock--scroll > .m-datatable__row"),
                                o.tableLocked = t(a.tableBody).find(".m-datatable__lock:not(.m-datatable__lock--scroll)"),
                                i > mUtil.getBreakpoint("lg") ? o.mCustomScrollbar(l) : o.defaultScrollbar(l)) : t(a.tableBody).find(".m-datatable__row").length > 0 && (o.scrollHead = t(a.tableHead).find("> .m-datatable__row"),
                                o.scrollFoot = t(a.tableFoot).find("> .m-datatable__row"),
                                i > mUtil.getBreakpoint("lg") ? o.mCustomScrollbar(a.tableBody) : o.defaultScrollbar(a.tableBody))
                            } else
                                t(a.table).css("overflow-x", "auto")
                        },
                        ...
                        onScrolling: function(e) {
                            var a = t(this).scrollLeft()
                              , n = t(this).scrollTop();
                            t(o.scrollHead).css("left", -a),
                            t(o.scrollFoot).css("left", -a),
                            t(o.tableLocked).each(function(e, a) {
                                t(a).css("top", -n)
                            })
                        },
                        mCustomScrollbar: function(e) {
                            ...
                            var l = t.extend({}, o.mcsOptions, {
                                ...
                                callbacks: {
                                    whileScrolling: function() {
                                        var e = this.mcs;
                                        t(o.scrollHead).css("left", e.left),
                                        t(o.scrollFoot).css("left", e.left),
                                        t(o.tableLocked).each(function(a, n) {
                                            t(n).css("top", e.top)
                                        }),
                                        clearTimeout(n.hoverTimer),
                                        n.isScrolling = !0
                            ...
                            !0 === n.getOption("layout.smoothScroll.scrollbarShown") && t(e).attr("data-scrollbar-shown", "true"),
                            n.mCustomScrollbar(e, l)
                        }
                    };
                    return o.init(),
                    o
                ...
                dataRender: function(o) {
                    ...
                    var i = function() {
                        ...
                        return a.dataSet = t(a.dataSet).slice(i, l),
                        o
                    }
                      , l = function(o) {
                        var l = function(e, o) {
                            ...
                            e.init(o)),
                            t(e.pager).off().on("m-datatable--on-goto-page", function(a) {
                                t(e.pager).remove(),
                                e.init(o)
                            });
                            var i = Math.max(o.perpage * (o.page - 1), 0)
                        ...
                        if (t(a.wrap).removeClass("m-datatable--error"),
                        e.pagination)
                ...
                insertData: function() {
                    ...
                    if (t.each(a.dataSet, function(i, l) {
                        ...
                        t(r).data("obj", l),
                        void 0 !== s[i] && t.each(s[i], function() {
                ...
                getData: function() {
                    ...
                    if ("local" === e.data.type && (o.url = e.data.source),
                    "remote" === e.data.type) {
                        ...
                        o.data = t.extend(!0, o.data, i, n.getOption("data.source.read.params"))
                    }
                    return t.ajax(o).done(function(e, o, i) {
                        ...
                        t(a.tableBody).html(t("<span/>").addClass("m-datatable--error").html(n.getOption("translate.records.noRecords"))),
                        t(a.wrap).addClass("m-datatable--error m-datatable--loaded"),
                        n.spinnerCallback(!1)
                    }).always(function() {})
                },
                paging: function(e, o) {
                    var i = {
                        ...
                        init: function(e) {
                            ...
                            t(i.pager).hasClass("m-datatable--paging-loaded") || (t(i.pager).remove(),
                        ...
                        populate: function() {
                            ...
                            t("<li/>").append(t("<a/>").attr("title", o.first).addClass("m-datatable__pager-link m-datatable__pager-link--first").append(t("<i/>").addClass(e.first)).on("click", i.gotoMorePage).attr("data-page", 1)).appendTo(l),
                            t("<li/>").append(t("<a/>").attr("title", o.prev).addClass("m-datatable__pager-link m-datatable__pager-link--prev").append(t("<i/>").addClass(e.prev)).on("click", i.gotoMorePage)).appendTo(l),
                            t("<li/>").append(t("<a/>").attr("title", o.more).addClass("m-datatable__pager-link m-datatable__pager-link--more-prev").html(t("<i/>").addClass(e.more)).on("click", i.gotoMorePage)).appendTo(l),
                            t("<li/>").append(t("<input/>").attr("type", "text").addClass("m-pager-input form-control").attr("title", o.input).on("keyup", function() {
                            ...
                            t("<li/>").append(t("<a/>").attr("title", o.more).addClass("m-datatable__pager-link m-datatable__pager-link--more-next").html(t("<i/>").addClass(e.more)).on("click", i.gotoMorePage)).appendTo(l),
                            t("<li/>").append(t("<a/>").attr("title", o.next).addClass("m-datatable__pager-link m-datatable__pager-link--next").append(t("<i/>").addClass(e.next)).on("click", i.gotoMorePage)).appendTo(l),
                            t("<li/>").append(t("<a/>").attr("title", o.last).addClass("m-datatable__pager-link m-datatable__pager-link--last").append(t("<i/>").addClass(e.last)).on("click", i.gotoMorePage).attr("data-page", i.meta.pages)).appendTo(l),
                            n.getOption("toolbar.items.info") && (i.pagerLayout.info = t("<div/>").addClass("m-datatable__pager-info").append(t("<span/>").addClass("m-datatable__pager-detail"))),
                        ...
                        paste: function() {
                            t.each(t.unique(n.getOption("toolbar.placement")), function(e, n) {
                                "bottom" === n && t(i.pager).clone(!0).insertAfter(a.table),
                                "top" === n && t(i.pager).clone(!0).addClass("m-datatable__pager--top").insertBefore(a.table)
                            })
                        },
                        ...
                        gotoPage: function(e) {
                            e.preventDefault(),
                            t(this).hasClass("m-datatable__pager-link--active") || i.openPage(parseInt(t(this).data("page")))
                        },
                        openPage: function(e) {
                        ...
                        updatePerpage: function(e) {
                            e.preventDefault(),
                            null === n.getOption("layout.height") && t("html, body").animate({
                                scrollTop: t(a).position().top
                            }),
                            i.pager = t(a.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"),
                            e.originalEvent && (i.meta.perpage = parseInt(t(this).val())),
                            t(i.pager).find("select.m-datatable__pager-size").val(i.meta.perpage).attr("data-selected", i.meta.perpage),
                        ...
                        addPaginateEvent: function(e) {
                            t(a).off(i.paginateEvent).on(i.paginateEvent, function(e, o) {
                                ...
                                t(l).find(".m-datatable__pager-link--active").removeClass("m-datatable__pager-link--active"),
                                t(l).find('.m-datatable__pager-link-number[data-page="' + o.page + '"]').addClass("m-datatable__pager-link--active"),
                                t(l).find(".m-datatable__pager-link--prev").attr("data-page", Math.max(o.page - 1, 1)),
                                t(l).find(".m-datatable__pager-link--next").attr("data-page", Math.min(o.page + 1, o.pages)),
                                t(i.pager).each(function() {
                                    t(this).find('.m-pager-input[type="text"]').prop("value", o.page)
                                }),
                                t(i.pager).find(".m-datatable__pager-nav").show(),
                                o.pages <= 1 && t(i.pager).find(".m-datatable__pager-nav").hide(),
                                n.setDataSourceParam("pagination", {
                                    page: i.meta.page,
                                    pages: i.meta.pages,
                                    perpage: i.meta.perpage,
                                ...
                                t(i.pager).find("select.m-datatable__pager-size").val(o.perpage).attr("data-selected", o.perpage),
                                t(a.table).find('.m-checkbox > [type="checkbox"]').prop("checked", !1),
                                t(a.table).find(".m-datatable__row--active").removeClass("m-datatable__row--active"),
                                i.updateInfo.call(),
                                i.pagingBreakpoint.call()
                            })
                        },
                        ...
                        pagingBreakpoint: function() {
                            ...
                            if (0 !== t(e).length) {
                                ...
                                t(e).find("li").show(),
                                t.each(n.getOption("toolbar.items.pagination.pages"), function(a, r) {
                                    if (mUtil.isInResponsiveRange(a)) {
                                        ...
                                        case "mobile":
                                            t(l).show(),
                                            t(e).find(".m-datatable__pager-link--more-prev").closest("li").hide(),
                        ...
                        paginationUpdate: function() {
                            ...
                            p === i.meta.pages && p === t(m).last().data("page") ? t(l).parent().hide() : t(l).parent().show(),
                            1 === i.meta.page ? (t(r).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"),
                            ...
                            i.meta.page === i.meta.pages ? (t(d).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"),
                ...
                columnHide: function() {
                    ...
                    t.each(e.columns, function(e, o) {
                        if (void 0 !== o.responsive) {
                            ...
                            mUtil.getBreakpoint(o.responsive.hidden) >= n ? t(l).hide() : t(l).show(),
                            mUtil.getBreakpoint(o.responsive.visible) <= n ? t(l).show() : t(l).hide()
                        }
                    })
                },
                setupSubDatatable: function() {
                    ...
                    if ("function" == typeof o && !(t(a.table).find(".m-datatable__subtable").length > 0)) {
                        ...
                        var i = function(i) {
                            ...
                            0 === t(r).length && (r = t("<tr/>").addClass("m-datatable__row-subtable m-datatable__row-loading").hide().append(t("<td/>").addClass("m-datatable__subtable").attr("colspan", n.getTotalColumns())),
                            t(l).after(r),
                            ...
                            t(l).hasClass("m-datatable__row--subtable-expanded") ? (t(c).addClass(n.getOption("layout.icons.rowDetail.collapse")),
                            t(l).removeClass("m-datatable__row--subtable-expanded"),
                            t(a).trigger("m-datatable--on-collapse-subtable", [l])) : (t(c).addClass(n.getOption("layout.icons.rowDetail.expand")),
                            t(l).addClass("m-datatable__row--subtable-expanded"),
                            t(a).trigger("m-datatable--on-expand-subtable", [l])),
                            0 === t(s).find(".m-datatable").length && (t.map(a.dataSet, function(t, a) {
                                return d === t[e.columns[0].field] && (i.data = t,
                                !0)
                            }),
                            i.detailCell = s,
                            i.parentRow = l,
                ...
                dataMapCallback: function(t) {
                    var e = t;
                    return "function" == typeof n.getOption("data.source.read.map") ? n.getOption("data.source.read.map")(t) : (void 0 !== t && void 0 !== t.data && (e = t.data),
                    e)
                },
                isSpinning: !1,
                spinnerCallback: function(t) {
                    if (t) {
                        if (!n.isSpinning) {
                            ...
                            !0 === e.message && (e.message = n.getOption("translate.records.processing")),
                            n.isSpinning = !0,
                ...
                log: function(t, e) {
                    void 0 === e && (e = ""),
                    a.debug && console.log(t, e)
                },
                autoHide: function() {
                    t(a.table).find(".m-datatable__cell").show(),
                    t(a.tableBody).each(function() {
                        for (; t(this)[0].offsetWidth < t(this)[0].scrollWidth; )
                            t(a.table).find(".m-datatable__row").each(function(e) {
                    ...
                    var o = function(a) {
                        ...
                        if (t(i).hasClass("m-datatable__row-detail"))
                            t(this).find("i").removeClass(n.getOption("layout.icons.rowDetail.expand")).addClass(n.getOption("layout.icons.rowDetail.collapse")),
                            t(i).remove();
                        else {
                    ...
                    t(a.tableBody).find(".m-datatable__row").each(function() {
                        t(this).prepend(t("<td/>").addClass("m-datatable__cell m-datatable__toggle--detail").append(t("<a/>").addClass("m-datatable__toggle-detail").attr("href", "#").on("click", o).append(t("<i/>").css("width", "21px").addClass(n.getOption("layout.icons.rowDetail.collapse"))))),
                        0 === t(a.tableHead).find(".m-datatable__toggle-detail").length ? (t(a.tableHead).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'),
                        t(a.tableFoot).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>')) : t(a.tableHead).find(".m-datatable__toggle-detail").find("span").css("width", "21px")
                    })
                },
                ...
                setAutoColumns: function() {
                    ...
                    t(a.tableHead).find(".m-datatable__row").remove(),
                    n.setHeadTitle(),
                    n.getOption("layout.footer") && (t(a.tableFoot).find(".m-datatable__row").remove(),
                ...
                replaceTableContent: function(e, n) {
                    ...
                    t(n).hasClass("mCustomScrollbar") ? t(n).find(".mCSB_container").html(e) : t(n).html(e)
                },
                ...
                getTableId: function(e) {
                    void 0 === e && (e = "");
                    var n = t(a).attr("id");
                    return void 0 === n && (n = t(a).attr("class").split(" ")[0]),
                    n + e
                },
                ...
                getDepth: function() {
                    var e = 0
                      , n = a.table;
                    do {
                        n = t(n).parents(".m-datatable__table"),
                        e++
                    } while (t(n).length > 0);return e
                },
                stateKeep: function(t, e) {
                    t = n.getTablePrefix(t),
                    !1 !== n.getOption("data.saveState") && (n.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(t, JSON.stringify(e)),
                    n.getOption("data.saveState.cookie") && Cookies.set(t, JSON.stringify(e)))
                },
                stateGet: function(t, e) {
                    if (t = n.getTablePrefix(t),
                ...
                sorting: function() {
                    var o = {
                        init: function() {
                            e.sortable && (t(a.tableHead).find(".m-datatable__cell:not(.m-datatable__cell--check)").addClass("m-datatable__cell--sort").off("click").on("click", o.sortClick),
                            o.setIcon())
                        },
                        setIcon: function() {
                        ...
                        sortClick: function(i) {
                            ...
                            if ((void 0 === s.sortable || !1 !== s.sortable) && (t(a.tableHead).find(".m-datatable__cell > span > i").remove(),
                            e.sortable)) {
                                n.spinnerCallback(!0);
                                var d = "desc";
                ...
                localDataUpdate: function() {
                    ...
                    "object" == typeof e.query && !n.getOption("data.serverFiltering")) {
                        e.query = e.query || {};
                        var r = function(t) {
                            for (var e in t)
                                if (t.hasOwnProperty(e))
                ...
                resetScroll: function() {
                    void 0 === e.detail && 1 === n.getDepth() && (t(a.table).find(".m-datatable__row").css("left", 0),
                    t(a.table).find(".m-datatable__lock").css("top", 0),
                    t(a.tableBody).scrollTop(0))
                },
                getColumnByField: function(a) {
                    var n;
                    if (void 0 !== a)
                        return t.each(e.columns, function(t, e) {
                            if (a === e.field)
                                return n = e,
                                !1
                        }),
                ...
                getRecord: function(e) {
                    return void 0 === a.tableBody && (a.tableBody = t(a.table).children("tbody")),
                    t(a.tableBody).find(".m-datatable__cell:first-child").each(function(o, i) {
                        if (e == t(i).text()) {
                ...
                sort: function(e, o) {
                    ...
                    setTimeout(function() {
                        ...
                        t(a.tableHead).find(".m-datatable__cell > span > i").remove()
                    }, 300),
                    a
                },
                getValue: function() {
                ...
                setActive: function(e) {
                    "string" == typeof e && (e = t(a.tableBody).find('.m-checkbox--single > [type="checkbox"][value="' + e + '"]')),
                    t(e).prop("checked", !0);
                ...
                setSelectedRecords: function() {
                    return a.API.record = t(a.tableBody).find(".m-datatable__row--active"),
                    a
                },
                ...
                showColumn: function(n) {
                    t.map(e.columns, function(t) {
                        return n === t.field && delete t.responsive,
                        t
                    });
                    var o = t.grep(t(a.table).find(".m-datatable__cell"), function(e, a) {
                        return n === t(e).data("field")
                ...
                destroyScroller: function(e) {
                    ...
                    t(e).each(function() {
                        if (t(this).hasClass("mCustomScrollbar"))
                            try {
                ...
                row: function(e) {
                    return n.rows(e),
                    n.nodeTr = n.recentNode = t(n.nodeTr).first(),
                    a
                },
                rows: function(e) {
                    return n.nodeTr = n.recentNode = t(a.tableBody).find(e).filter(".m-datatable__row"),
                    a
                },
                column: function(e) {
                    return n.nodeCols = n.recentNode = t(a.tableBody).find(".m-datatable__cell:nth-child(" + (e + 1) + ")"),
                    a
                },
                columns: function(e) {
                    var o = a.table;
                    ...
                    return i.length > 0 ? n.nodeCols = n.recentNode = i : n.nodeCols = n.recentNode = t(o).find(e).filter(".m-datatable__cell"),
                    a
                },
                cell: function(e) {
                    return n.cells(e),
                    n.nodeTd = n.recentNode = t(n.nodeTd).first(),
                    a
                },
                cells: function(e) {
                    var o = t(a.tableBody).find(".m-datatable__cell");
                    return void 0 !== e && (o = t(o).filter(e)),
                    n.nodeTd = n.recentNode = o,
                    a
                },
                remove: function() {
                    return t(n.nodeTr.length) && n.nodeTr === n.recentNode && t(n.nodeTr).remove(),
                    n.layoutUpdate(),
                    a
                },
                visible: function(a) {
                    if (t(n.recentNode.length)) {
                        ...
                        a ? (n.recentNode === n.nodeCols && delete e.columns[i].responsive,
                        t(n.recentNode).show()) : (n.recentNode === n.nodeCols && n.setOption("columns." + i + ".responsive", {
                            hidden: "xl"
                        }),
                        t(n.recentNode).hide()),
                        n.redraw()
            ...
            void 0 !== e)
                if ("string" == typeof e) {
                    var o = e;
                    void 0 !== (a = t(this).data("mDatatable")) && (e = a.options,
                    n[o].apply(this, Array.prototype.slice.call(arguments, 1)))
                } else
                    a.data("mDatatable") || t(this).hasClass("m-datatable--loaded") || (a.dataSet = null,
                    a.textAlign = {
                ...
                void 0 === (a = t(this).data("mDatatable")) && t.error("mDatatable not initialized"),
                e = a.options;
            return a
        }
        ...
        var i = {
          ...
          , l = {
            ...
            adjustArrowPos: function() {
                ...
                "right" == e ? (mUtil.css(a.layout.arrow, "left", "auto"),
...
!function(t) {
    ...
    t.fn.mDatatable.checkbox = function(e, a) {
        var n = {
            ...
            unselectedRows: [],
            init: function() {
                n.selectorEnabled() && (a.vars.requestIds && e.setDataSourceParam(a.vars.requestIds, !0),
...
var mLayout = function() {
    ...
    return {
        ...
        initAside: function() {
            ...
            l = mUtil.hasClass(n, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left",
