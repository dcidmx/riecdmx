! function(n, e) {
            ...
            e && e.parentNode.removeChild(e); {
                if ("undefined" != typeof document) {
                    ...
                    return r.oninput = function() {
                        ...
                        setTimeout(function() {
                            13 === e.keyCode && n.allowEnterKey && (e.stopPropagation(), X.clickConfirm())
                        }, 0)
                    }, i.onchange = function() {
                        X.resetValidationError()
                    }, l.oninput = function() {
    ...
    var U = function(n) {
            ...
            if (n.titleText ? m.innerText = n.titleText : m.innerHTML = n.title.split("\n").join("<br />"), n.text || n.html) {
                if ("object" === I(n.html))
                    if (y.innerHTML = "", 0 in n.html)
                        for (var H = 0; H in n.html; H++) y.appendChild(n.html[H].cloneNode(!0));
                    else y.appendChild(n.html.cloneNode(!0));
                else n.html ? y.innerHTML = n.html : n.text && (y.textContent = n.text);
                T(y)
            } else q(y);
            ...
            if (n.type) {
                ...
                var W = e.querySelector("." + t.icon + "." + o[n.type]);
                if (T(W), n.animation) switch (n.type) {
                    case "success":
                ...
                var R = function(n, e) {
                    ...
                    K = function(t) {
                        var a = t || window.event,
                            r = a.keyCode || a.which;
                        if (-1 !== [9, 13, 32, 27, 37, 38, 39, 40].indexOf(r)) {
                            for (var s = a.target || a.srcElement, l = S(i.focusCancel), c = -1, u = 0; u < l.length; u++)
                                if (s === l[u]) {
                                    c = u;
                                    break
                                }
                            9 === r ? (a.shiftKey ? R(c, -1) : R(c, 1), a.stopPropagation(), a.preventDefault()) : 37 === r || 38 === r || 39 === r || 40 === r ? document.activeElement === O && H(N) ? N.focus() : document.activeElement === N && H(O) && O.focus() : 27 === r && !0 === i.allowEscapeKey && (n.closeModal(i.onClose), i.useRejections ? o("esc") : e({
                                dismiss: "esc"
                            }))
                        }
                    };
                window.onkeydown && window.onkeydown.toString() === K.toString() || (l.previousWindowKeyDown = window.onkeydown, window.onkeydown = K), i.buttonsStyling && (O.style.borderLeftColor = i.confirmButtonColor, O.style.borderRightColor = i.confirmButtonColor), n.hideLoading = n.disableLoading = function() {
                    i.showConfirmButton || (q(O), i.showCancelButton || q(b())), P(M, t.loading), P(u, t.loading), u.removeAttribute("aria-busy"), O.disabled = !1, N.disabled = !1
                }, n.getTitle = function() {
                    return w()
    ...
    return X.isVisible = function() {
        ...
        return new Promise(function(n, o) {
            ! function a(r, i) {
                r < W.length ? (document.body.setAttribute("data-swal2-queue-step", r), X(W[r]).then(function(n) {
                    t.push(n), a(r + 1, i)
                }, function(n) {
                    e(), o(n)
                })) : (e(), n(t))
        ...
        return e && e < W.length ? W.splice(e, 0, n) : W.push(n)
        ...
        K = R({}, n)
    }, X.noop = function() {}, X.version = "6.10.1", X.default = X, X
